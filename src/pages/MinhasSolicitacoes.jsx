      ...
      <div className="minhas-solicitacoes-layout">
        ...
        <aside className="minhas-solicitacoes-sidebar">
          <nav className="minhas-solicitacoes-nav-menu">
            ...
            <button 
              className={`minhas-solicitacoes-nav-item ${menuAtivo === "retiradas" ? "active" : ""}`}
              onClick={() => { setMenuAtivo("retiradas"); navigate("/retiradas-agendadas"); }}
            >
              🚚 Retiradas Agendadas
            </button>
            <button 
            ...
            <button 
              ...
              onClick={() => { setMenuAtivo("configuracoes"); navigate("/perfil-ong"); }}
            >
              ⚙️ Configurações
            </button>
          </nav>
              ...
              {solicitacoesFiltradas.map((solicitacao) => (
                <div key={solicitacao.id_solicitacao} className="minhas-solicitacoes-solicitacao-card">
                  ...
                  <div className="minhas-solicitacoes-solicitacao-footer">
                    ...
                    {/* Cancelar Solicitação (apenas pendentes) */}
                    ...
                    {solicitacao.status === "aprovada" && (
                      <button
                        ...
                        disabled={solicitacao.Retirada != null} 
                        style={{
                          opacity: solicitacao.Retirada ? 0.5 : 1,
                          cursor: solicitacao.Retirada ? "not-allowed" : "pointer"
                        }}
                      >
                        Agendar Retirada
                      </button>
                    ...
                    <button
                      ...
                      disabled={solicitacao.Retirada == null}
                      style={{
                        opacity: solicitacao.Retirada ? 1 : 0.5,
                        cursor: solicitacao.Retirada ? "pointer" : "not-allowed"
                      }}
                    >
                      Ver Detalhes
                    </button>
