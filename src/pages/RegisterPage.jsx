...
function RegisterPage() {
  ...
  // Pega o tipo da URL, se não tiver usa 'ong' como padrão
  const tipoInicial = searchParams.get("tipo") || "ong";
  ...
  // Atualiza o tipo quando o parâmetro da URL mudar
  useEffect(() => {
    const tipoUrl = searchParams.get("tipo");
    if (tipoUrl && (tipoUrl === "empresa" || tipoUrl === "ong")) {
      setTipo(tipoUrl);
    }
  }, [searchParams]);
    ...
    <div className="register-wrapper">
      <div className="register-container">
        ...
        <div className="register-right">
          <h2>
            {tipo === "ong" ? "Cadastro de ONG" : "Cadastro de Empresa"}
          </h2>
          
          {/* Badge informativo */}
          <div className="tipo-badge">
            {tipo === "ong" ? "🤝 Organização Não Governamental" : "🏢 Pessoa Jurídica"}
          </div>

          <form className="register-form" onSubmit={handleSubmit}>
            {/* Campo hidden para garantir que o tipo seja enviado */}
            ...
            {/* Link para mudar tipo de cadastro */}
            <p className="link-trocar-tipo">
              {tipo === "ong" 
                ? <>É uma empresa? <Link to="/register?tipo=empresa">Cadastre-se como Empresa</Link></>
                : <>É uma ONG? <Link to="/register?tipo=ong">Cadastre-se como ONG</Link></>
              }
            </p>
          </form>
        </div>
